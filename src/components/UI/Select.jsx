...
function Select({ title, icon, options, description }) {
  return (
    <div className="w-full">
      ...
      <select className="w-full p-3 rounded-md text-right border border-gray-300 outline-none focus:border-green-500">
        {options.map((opt, idx) => (
