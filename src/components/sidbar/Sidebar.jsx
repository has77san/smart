...
function Sidebar() {
  ...
  const menuItems = [
      ...
      subItems: [
        {
          ...
          icon: (
            <svg
              class="svg-inline--fa fa-truck-fast"
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
    ...
    },
    {
      ...
      icon: (
        <svg
          class="svg-inline--fa fa-boxes-stacked"
          aria-hidden="true"
          focusable="false"
          data-prefix="fas"
  ...
  return (
    <div className="sidebar">
      <div className="sidbar_header h-[150px]">
        <div className="logo h-[60px]">
          <h1>
            {" "}
            شحنكو <span>.</span>
          </h1>
        ...
        <div className="user-info">
          <div className="header_active mr-[30px]">
  ...
  {menuItems.map((item, index) => (
    <li key={index} className="menu-item-container w-full">
      {item.subItems ? (
        <>
          <div
          ...
          {/* القائمة الفرعية */}
          <ul
            className={`submenu pl-6 transition-all duration-300 ease-in-out overflow-hidden ${
              openDropdown === index ? "max-h-96 opacity-100" : "max-h-0 opacity-0"
            }`}
          >
            {item.subItems.map((sub, subIndex) => (
              <li key={subIndex} className="submenu-item flex items-center gap-2 py-2">
                {sub.path ? (
