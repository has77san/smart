    ...
    <Master>
      <div className="container-main slide-up">
        ...
        <div className="flex justify-between w-[160vh]">
          <div className="bg-[#1d9e62] text-[#fff] rounded-[5px] hover:bg-[#198754] h-[30px] ml-[50px]">
            <button className="flex cursor-pointer ml-[20px]">
                انشاء تقرير 
          ...
          <div className="ml-[0px]">
            ...
            <div className="">
              <p className="ml-[80px]">إدارة وعرض جميع التقارير المخصصة</p>
            </div>
          </div>
        </div><br/>
